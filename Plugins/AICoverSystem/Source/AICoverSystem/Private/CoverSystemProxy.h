...
public:
	...
	bool GenerateCovers(bool bAsync, bool bRegenerate, UWorld* World, const FCoverBuildParams& Params, const FVector& Origin, const TArray<FCoverData>* AdditionalData = nullptr);
