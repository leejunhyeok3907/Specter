...
public:
	...
	FCoverGenerateAsyncTask(UWorld* World, FCoverSystemProxy* InProxy, ARecastNavMesh* NavMesh, const FCoverBuildParams& Params, const FVector& InOrigin, const TArray<FCoverData>* AdditionalData);
